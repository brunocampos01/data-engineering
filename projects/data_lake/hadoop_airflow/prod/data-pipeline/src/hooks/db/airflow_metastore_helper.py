...
class AirflowMetaStoreHelper(PostgresHook):
    ...
    def set_granularity(list_all_dates: list, agg_by: str) -> 'generator':
        ...
        Examples
        --------
            input: ['01-12-2006', '02-01-2006', '02-01-2006', ...]
            output (agg_by=month): ['01-12-2006', '01-01-2006', ...]
        """
        if agg_by == 'month':
    ...
    def generate_list_inconsistency(self, dag_name: str, last_control_var: str, layer: str) -> list:
        ...
        :return:
            ...
            ex: [dime_212000003126407_data_inconsistency_01-01-2006,
                dime_212000003126407_data_inconsistency_01-02-2006, ...]
        """
