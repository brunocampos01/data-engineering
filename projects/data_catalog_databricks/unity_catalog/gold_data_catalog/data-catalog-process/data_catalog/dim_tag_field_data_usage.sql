...
DROP TABLE IF EXISTS dim_tag_field_data_usage;

CREATE TABLE dim_tag_field_data_usage (
...
LOCATION 'abfss://gold@${storage_account}.dfs.core.windows.net/data_catalog/dim_tag_field_data_usage';

-- COMMAND ----------

ALTER TABLE dim_tag_field_data_usage OWNER TO ${data_owner};

-- COMMAND ----------

ALTER TABLE dim_tag_field_data_usage ADD CONSTRAINT `gold_dim_tag_field_data_usage_sk` PRIMARY KEY(`sk_tag_field_data_usage`);
