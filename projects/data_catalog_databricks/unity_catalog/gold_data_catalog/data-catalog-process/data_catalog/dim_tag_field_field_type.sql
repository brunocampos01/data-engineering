...
DROP TABLE IF EXISTS dim_tag_field_field_type;

CREATE TABLE dim_tag_field_field_type (
...
LOCATION 'abfss://gold@${storage_account}.dfs.core.windows.net/data_catalog/dim_tag_field_field_type';

-- COMMAND ----------

ALTER TABLE dim_tag_field_field_type OWNER TO ${data_owner};

-- COMMAND ----------

ALTER TABLE dim_tag_field_field_type ADD CONSTRAINT `gold_dim_tag_field_field_type_sk` PRIMARY KEY(`sk_tag_field_field_type`);
