...
DROP TABLE IF EXISTS dim_tag_table_frequency_ingestion;

CREATE TABLE dim_tag_table_frequency_ingestion (
...
LOCATION 'abfss://gold@${storage_account}.dfs.core.windows.net/data_catalog/dim_tag_table_frequency_ingestion';

-- COMMAND ----------

ALTER TABLE dim_tag_table_frequency_ingestion OWNER TO ${data_owner};

-- COMMAND ----------

ALTER TABLE dim_tag_table_frequency_ingestion ADD CONSTRAINT `gold_dim_tag_table_frequency_ingestion_sk` PRIMARY KEY(`sk_tag_table_frequency_ingestion`);
