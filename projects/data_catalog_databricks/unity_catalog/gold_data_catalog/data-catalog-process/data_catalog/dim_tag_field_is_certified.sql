...
DROP TABLE IF EXISTS dim_tag_field_is_certified;

CREATE TABLE dim_tag_field_is_certified (
...
LOCATION 'abfss://gold@${storage_account}.dfs.core.windows.net/data_catalog/dim_tag_field_is_certified';

-- COMMAND ----------

ALTER TABLE dim_tag_field_is_certified OWNER TO ${data_owner};

-- COMMAND ----------

ALTER TABLE dim_tag_field_is_certified ADD CONSTRAINT `gold_dim_tag_field_is_certified_sk` PRIMARY KEY(`sk_tag_field_is_certified`);
