...
LOCATION 'abfss://silver@${storage_account}.dfs.core.windows.net/data_catalog/tables';
...
ALTER TABLE tables ADD CONSTRAINT `silver_tables_table_id` PRIMARY KEY(`table_id`);
