...
for ano in range(2017,2019): 
    #print(ano)
    query_year = deals[(deals['dealsDateCreated'].dt.year==ano)]
...
companies_sectors = pd.merge(companies[colunas_necessarias_companies], sectors,
                             left_on='sectorKey', right_on='sectorKey')

# join entre deals e companies_sectors
deals_companies_sectors = pd.merge( deals, companies_sectors,
...
dict_setor = {1.0:"Bens de Consumo", 2:"Serviços", 3:"Tecnologia", 4.0:"Indústria", 5:"Varejo", 6:"Atacado"}
