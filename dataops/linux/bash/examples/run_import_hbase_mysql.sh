...
HDFS_PATH="hdfs:///user/bigdata/etl/conf/storeList"
STORE_TO_PROCESS=""
...
cat << EOF
    ...
    Example: ./runImportForAllStores.sh -sd 2019-02-02 -ed 2019-02-03 -store magalu -ddl drop
...
runImport(){
    ...
    local JAR="name_app-0.0.1-SNAPSHOT-jar-with-dependencies.jar"
    local MAIN_CLASS="com.import.main.Import"
